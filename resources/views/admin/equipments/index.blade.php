@extends('layouts.app', ['page' => __('All equipments'), 'pageSlug' => 'equipments'])
...
@section('content')
    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-12">
                {{ Form::open(['method'=>'DELETE', 'action'=>'EquipmentController@delete', 'class'=>'form-inline']) }}
                <div class="card ">
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($equipments as $equipment)
                                    <tr>
                                        ...
                                        <td>{{ $equipment->created_at->diffForHumans() ?? 'No date' }}</td>
                                        <td class="text-right">
                                            <div class="dropdown">
